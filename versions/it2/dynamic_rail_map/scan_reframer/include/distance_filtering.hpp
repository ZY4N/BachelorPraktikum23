 ...
 */
[[nodiscard]] inline auto create_simple_filter(double max_distance);
 ...
 * @return The generated lambda.
 */
[[nodiscard]] inline auto create_peripheral_filter(double max_radial_distance, double max_peripheral_distance);

} // namespace drm::distance_filtering

#define INCLUDE_DISTANCE_FILTERING_IMPLEMENTATION
#include "distance_filtering.ipp"
