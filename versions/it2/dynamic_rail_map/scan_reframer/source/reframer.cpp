...
std::error_category& drm::reframer_error_category(){
	static reframer_error::category category;
	return category;
}

std::error_code drm::reframer_error::make_error_code(codes e){
...
template<typename T>
double drm::reframer_internal::calculate_t(const T& p0, const T& p1){
