...
std::error_code drm::frame_exporter_internal::write_pose_to_uos_file(
	...
	out << std::hexfloat << pose.translation.x() << " "
		<< std::hexfloat << pose.translation.y() << " "
		<< std::hexfloat << pose.translation.z() << "\n";
	...
	out << std::hexfloat << to_degrees * angle_x << " "
		<< std::hexfloat << to_degrees * angle_y << " "
		<< std::hexfloat << to_degrees * angle_z;
