...
template<typename... Args>
std::string emulate_error(
	Args&& ... args
) {
	return emulate_println(
		ansi_colors::light_red,
		ansi_colors::red,
		"error", "   ",
		std::forward<Args>(args)...
	);
...
template<typename... Args>
std::string emulate_warn(
	Args&& ... args
) {
	return emulate_println(
		ansi_colors::light_yellow,
		ansi_colors::yellow,
		"warning", " ",
		std::forward<Args>(args)...
	);
...
template<typename... Args>
std::string emulate_log(
	Args&& ... args
) {
	return emulate_println(
		ansi_colors::light_white,
		ansi_colors::white,
		"log", "     ",
		std::forward<Args>(args)...
	);
...
template<typename... Args>
std::string emulate_debug(
	Args&& ... args
) {
	return emulate_println(
		ansi_colors::light_blue,
		ansi_colors::blue,
		"debug", "   ",
		std::forward<Args>(args)...
	);
