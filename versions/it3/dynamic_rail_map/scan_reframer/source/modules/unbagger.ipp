...
[[nodiscard]] std::pair<ros::Time, ros::Time> unbagger::get_absolute_ros_interval(
	...
	const auto absolute_min_time = min_time + m_bag_starting_time;
	const auto absolute_max_time = max_time + m_bag_starting_time;
...
std::error_code unbagger::extract_points_if(
	...
	const types::timestamp_t min_time,
	const types::timestamp_t max_time,
	...
	return lidar_point_parser(lidar_frames_view, lidar_points, lidar_point_predicate);
}
