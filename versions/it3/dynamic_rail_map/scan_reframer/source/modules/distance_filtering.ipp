...
auto drm::distance_filtering::create_simple_filter(double max_distance) noexcept {
...
auto drm::distance_filtering::create_peripheral_filter(
	double max_radial_distance, double max_peripheral_distance
) noexcept {
	return [max_distance_sq = std::pow(max_radial_distance, 2.0),
	        max_peripheral_distance_sq = std::pow(max_peripheral_distance, 2.0)](const types::translation_t& point) {
