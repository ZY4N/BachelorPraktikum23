...
int main(int num_args, char* args[]) {
	...
	const std::size_t num_threads = my_arx.template get<args::threads>().value_or(48); // 12
	...
	const auto time_per_block = my_arx.template get<args::time_per_block>().value_or(1h); // 5min
