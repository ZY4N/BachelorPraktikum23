...
```
cd existing_repo
git remote add origin https://git.rwth-aachen.de/fzd/maas/dynamic_rail_map.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.rwth-aachen.de/fzd/maas/dynamic_rail_map/-/settings/integrations)
...
Every project is different, so consider which of these sections combine to yours. The sections used in the template are
